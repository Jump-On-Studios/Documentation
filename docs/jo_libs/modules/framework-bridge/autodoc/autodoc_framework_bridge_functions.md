...
### <Badge type="server" text="Server" /> jo.framework:getJob()
...
### <Badge type="shared" text="Shared" /> jo.framework:loadInventoryFiles()

<!-- @include: ./slots/headers.md#shared|jo.framework:loadInventoryFiles -->

<!-- @include: ./slots/descriptions.md#shared|jo.framework:loadInventoryFiles -->
...
<!-- @include: ./slots/examples.md#shared|jo.framework:loadInventoryFiles -->
